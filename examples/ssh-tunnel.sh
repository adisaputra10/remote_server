...
echo "   ./agent -id $AGENT_ID -relay-url $RELAY_URL/agent -allow 127.0.0.1:$TARGET_SSH_PORT -token $TUNNEL_TOKEN"

# On your local machine
echo "2. On local machine, run:"
echo "   ./client -L :$LOCAL_SSH_PORT -relay-url $RELAY_URL/client -agent $AGENT_ID -target 127.0.0.1:$TARGET_SSH_PORT -token $TUNNEL_TOKEN"
