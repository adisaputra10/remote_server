@echo off
echo ===============================================
echo Testing Client ID in Database Queries
echo ===============================================
...
type logs\AGENT-agent-linux.log | tail -15

echo.
echo === Relay Server Logs (last 15 lines) ===
...
echo.
echo ===============================================
echo Test completed. Check dashboard Database Queries for client ID.
echo ===============================================
pause